...
#ifdef _DEBUG
		_smp::message_pool::getInstance().push(new message(L"[mssql::init][Log] Inicializou mssql instancia com sucesso!", CL_FILE_LOG_AND_CONSOLE));
#endif
...
#ifdef _DEBUG
	_smp::message_pool::getInstance().push(new message(L"[mssql::destroy][Log] Destruiu o mssql instancia.", CL_FILE_LOG_AND_CONSOLE));
#endif
};
...
#ifdef _DEBUG
		_smp::message_pool::getInstance().push(new message(L"[mssql::connect][Log] Connectou com o HOST=" + m_db_address + L"\tDATABASE=" + m_db_name + L"\tUID=" + m_user_name + L"\tPWD=" + m_user_pass, CL_FILE_LOG_AND_CONSOLE));
#endif
	}catch (exception& e) {
...
#ifdef _DEBUG
	_smp::message_pool::getInstance().push(new message(L"[mssql::disconnect][Log] Desconnectou do HOST=" + m_db_address, CL_FILE_LOG_AND_CONSOLE));
#endif
};
